    ...
    return [
      {
        ...
        subtitle: `Welcome to Harish Eknath Somavate Portfolio,
Have a seat and enjoy the ride!`,
      },
      {
        ...
        title: "Experience",
        subtitle: `Nexus Info(Dec 2023-Mar 2024) as Software Engineer`,
      },
      {
        cameraRailDist: -1,
        position: new Vector3(
...
• Ruby on Rails • AWS`
      },
      {
        ...
        title: "EDUCATION",
        subtitle: `BHARATI V. UNIVERSITY
        B.Tech in Computer Science Eng
        Expected June 2025 | Mumbai, India
        Cum.GPA: 9.4/10
        `,
      },
    ];
